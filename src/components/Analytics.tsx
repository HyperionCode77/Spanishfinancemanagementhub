      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">
            Análisis detallado de tu rendimiento empresarial
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 flex items-center gap-1 mt-1">
              ...
              <span className="text-green-600">+18.2%</span> vs
              período anterior
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 flex items-center gap-1 mt-1">
              ...
              <span className="text-red-600">+12.5%</span> vs
              período anterior
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 flex items-center gap-1 mt-1">
              <TrendingUp className="h-3 w-3 text-green-600" />
              <span className="text-green-600">+32.4%</span> vs
              período anterior
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600 flex items-center gap-1 mt-1">
              <TrendingUp className="h-3 w-3 text-green-600" />
              <span className="text-green-600">+4.2pp</span> vs
              período anterior
            </p>
          </CardContent>
        </Card>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(totalProfit / 150000) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <p className="text-xs text-gray-600 mt-1">
                      {((totalProfit / 150000) * 100).toFixed(
                        1,
                      )}
                      % completado
                    </p>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(totalRevenue / 600000) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <p className="text-xs text-gray-600 mt-1">
                      {((totalRevenue / 600000) * 100).toFixed(
                        1,
                      )}
                      % completado
                    </p>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        ...
                        style={{
                          width: `${(profitMargin / 30) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <p className="text-xs text-gray-600 mt-1">
                      Actual: {profitMargin.toFixed(1)}%
                    </p>
                  </div>
                </div>
              </CardContent>
